...
namespace RolePlaySet
{
    public interface RolePlayGame
    {
        ...
        void AddTurnTaskEvent(string actualEventDescription, string playerName, int basePoint, int extraPoint, int numberOfDice, string diceType, TaskEvent evenetPoint);
    }
}
